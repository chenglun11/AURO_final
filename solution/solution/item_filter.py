...
from solution_interfaces.msg import Item, NearestItem
...
class ItemSensorFilter(Node):
    ...
    def __init__(self):
        ...
        self.nearest_iteams_publisher = self.create_publisher(NearestItem, 'items/near', 10)
    ...
    def item_callback(self, items):
        ...
        nearest_items = NearestItem()
        # nearest_items.nearest = nearest_item # msg
